...
pub trait IOfflineFilesSetting_Impl: Sized {
    ...
    fn GetPreference(&self, pvarvalue: *mut ::windows::core::VARIANT, dwscope: u32) -> ::windows::core::Result<()>;
    fn GetPreferenceScope(&self) -> ::windows::core::Result<u32>;
    fn SetPreference(&self, pvarvalue: *const ::windows::core::VARIANT, dwscope: u32) -> ::windows::core::Result<()>;
    fn DeletePreference(&self, dwscope: u32) -> ::windows::core::Result<()>;
    fn GetPolicy(&self, pvarvalue: *mut ::windows::core::VARIANT, dwscope: u32) -> ::windows::core::Result<()>;
    fn GetPolicyScope(&self) -> ::windows::core::Result<u32>;
    fn GetValue(&self, pvarvalue: *mut ::windows::core::VARIANT, pbsetbypolicy: *mut super::super::Foundation::BOOL) -> ::windows::core::Result<()>;
}
#[cfg(feature = "Win32_Foundation")]
...
impl IOfflineFilesSetting_Vtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl<Impl = Impl>, Impl: IOfflineFilesSetting_Impl, const OFFSET: isize>() -> IOfflineFilesSetting_Vtbl {
        ...
        unsafe extern "system" fn GetPreference<Identity: ::windows::core::IUnknownImpl<Impl = Impl>, Impl: IOfflineFilesSetting_Impl, const OFFSET: isize>(this: *mut ::core::ffi::c_void, pvarvalue: *mut ::windows::core::VARIANT, dwscope: u32) -> ::windows::core::HRESULT {
            let this = (this as *const *const ()).offset(OFFSET) as *const Identity;
            let this = (*this).get_impl();
        ...
        unsafe extern "system" fn SetPreference<Identity: ::windows::core::IUnknownImpl<Impl = Impl>, Impl: IOfflineFilesSetting_Impl, const OFFSET: isize>(this: *mut ::core::ffi::c_void, pvarvalue: *const ::windows::core::VARIANT, dwscope: u32) -> ::windows::core::HRESULT {
            let this = (this as *const *const ()).offset(OFFSET) as *const Identity;
            let this = (*this).get_impl();
        ...
        unsafe extern "system" fn GetPolicy<Identity: ::windows::core::IUnknownImpl<Impl = Impl>, Impl: IOfflineFilesSetting_Impl, const OFFSET: isize>(this: *mut ::core::ffi::c_void, pvarvalue: *mut ::windows::core::VARIANT, dwscope: u32) -> ::windows::core::HRESULT {
            let this = (this as *const *const ()).offset(OFFSET) as *const Identity;
            let this = (*this).get_impl();
        ...
        unsafe extern "system" fn GetValue<Identity: ::windows::core::IUnknownImpl<Impl = Impl>, Impl: IOfflineFilesSetting_Impl, const OFFSET: isize>(this: *mut ::core::ffi::c_void, pvarvalue: *mut ::windows::core::VARIANT, pbsetbypolicy: *mut super::super::Foundation::BOOL) -> ::windows::core::HRESULT {
            let this = (this as *const *const ()).offset(OFFSET) as *const Identity;
            let this = (*this).get_impl();
