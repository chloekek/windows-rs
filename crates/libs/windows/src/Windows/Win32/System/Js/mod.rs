...
#[doc = "*Required features: `\"Win32_System_Js\"`*"]
#[inline]
pub unsafe fn JsValueToVariant(object: *const ::core::ffi::c_void, variant: *mut ::windows::core::VARIANT) -> JsErrorCode {
    ::windows::core::link ! ( "chakra.dll""system" fn JsValueToVariant ( object : *const ::core::ffi::c_void , variant : *mut :: windows::core::VARIANT ) -> JsErrorCode );
    JsValueToVariant(object, ::core::mem::transmute(variant))
}
#[doc = "*Required features: `\"Win32_System_Js\"`*"]
#[inline]
pub unsafe fn JsVariantToValue(variant: *const ::windows::core::VARIANT, value: *mut *mut ::core::ffi::c_void) -> JsErrorCode {
    ::windows::core::link ! ( "chakra.dll""system" fn JsVariantToValue ( variant : *const :: windows::core::VARIANT , value : *mut *mut ::core::ffi::c_void ) -> JsErrorCode );
